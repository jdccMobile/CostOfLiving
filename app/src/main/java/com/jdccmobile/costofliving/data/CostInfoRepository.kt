...
class CostInfoRepository(
    ...
    suspend fun saveUserCountryPrefs(countryName: String) =
        preferencesDataSource.putUserCountryPrefs(countryName)

    // Remote requests
    suspend fun requestCitiesList() = remoteDataSource.getCitiesList()
    suspend fun requestCityCost(cityName: String, countryName: String) =
        remoteDataSource.getCityCost(cityName, countryName)

    suspend fun requestCountryCost(countryName: String) =
